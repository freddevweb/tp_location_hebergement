                ...
                <div class="form-group">
                    ...
                    <div class="checkbox ">
                        <label for="fumeur" class="checkbox">
                            <input type="checkbox" name="fumeur" value="fumeur" id="fumeur">
                            Fumeur
                        </label>
                    </div>
                    <div class="checkbox ">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12-col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name ="chambre" id="titre">
                </div>
                <div class="form-group">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12-col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <input type="time" class="form-control" name ="depart" id="depart">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12-col-xs-12">
                <div class="form-group">
